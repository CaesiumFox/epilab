...
- [ ] Инструменты
  - [ ] Подбор цвета (Color picker)
    - [ ] Picker (квадрат и полоска)
    - [ ] HSB
    - [ ] HSL
    - [ ] RGB
    - [ ] CMYK
    - [ ] Lab
    - [ ] по имени в базе данных сайта
    - [ ] выбор среди сохранённых цветов
    - [ ] плашечные цвета (премиум)
      - [ ] RAL
      - [ ] HKS
      - [ ] Copic
      - [ ] Prismacolor
...
1. [ ] Должна быть возможность выбрать цвет в нескольких цветовых моделях:
